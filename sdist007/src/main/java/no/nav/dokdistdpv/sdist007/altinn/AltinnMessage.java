...
public class AltinnMessage {
	...
	public static final String SERVICE_CODE = "4255";
	...
	public static final String MESSAGE_BODY = """
			<html>
			<head>
			    <title>Din virksomhet har uåpnet taushetsbelagt post fra Nav</title>
			</head>
			<body>
			<p>Dere mottar denne meldingen fordi virksomheten har uåpnet taushetsbelagt post fra Nav i Altinn. Vi anbefaler at dere
			...
			<p>Ønsker du hjelp og veiledning, kontakt <a href="https://www.altinn.no/hjelp/">Altinn brukerservice</a>.</p>
			</body>
			</html>
			""";

	private AltinnMessage() {
	}
}
