...
public class BehandleAltinnMeldingHendelseService {
	...
	public void lesOgBehandleAltinnMelding(ConsumerRecord<String, CloudEvent> altinnHendelseConsumerRecord) {
		...
		try {
			...
			log.info("kdist003 har mottatt hendelse med id={}, resourceinstance={}, type={}",
					cloudEvent.getId(), getExtension(cloudEvent, "resourceinstance"), cloudEvent.getType());
	...
	private void loggIngenBehandling(CloudEvent cloudEvent) {
		log.info("Hendelse med resourceinstance={}, type={} har ingen behandling", getExtension(cloudEvent, "resourceinstance"), cloudEvent.getType());
	}
