...
public class Kdist003Validator {
	...
	public static void validateAltinnEvent(AltinnEventMelding altinnEventMelding) {
		if (!RESOURCE.equals(altinnEventMelding.resource())) {
			throw new IllegalArgumentException("Ugyldig verdi: resource er ikke lik " + altinnEventMelding.resource());
		}

		if (!ALTERNATIVE_SUBJECT.equals(altinnEventMelding.alternativesubject())) {
